    ...
    <table class="email-wrapper" width="100%" cellpadding="0" cellspacing="0" role="presentation">
        <tr>
                                ...
                                <tr>
                                    <td class="content-cell">
                                        <div class="f-fallback">
                                            ...
                                            <p>You recently requested to reset your password for your PPC Leads To Deals account. Use the button below to reset it. <strong>This password reset is only valid for the next 24 hours.</strong></p>
                                            <!-- Action -->
           ...
           https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
                                            ...
                                            <p>Thanks,
                                                <br>The PPC Leads To Deals team
                                            </p>
                                        </div>
                                    </td>
                                </tr>
